...
- Export target folder or Godot project export directory
- GLB vs GLTF
- Active preset
- Use Safe Godot Defaults
- Preserve Content Browser folders
- Scene lights/cameras/lightmaps/vertex colors
- Prefab origin mode
- Export tag prefix
- Collision export mode
- Validation report generation
- Full-level export warning
- Dry-run diff generation
- Godot import preset JSON generation
- Output cleanup/archive behavior
- Versioned scene exports for CI/artifact history

## Limitations

This is a geometry/layout pipeline, not a full Unreal-to-Godot project converter.

Expected to work well:

- Static Mesh assets
- Modular environment chunks
- Greybox/blockout levels
- Placed prop layouts
- Simple prefab rooms
- Basic transform hierarchy
- Basic materials/textures via glTF/GLB

Requires cleanup/rebuilding in Godot:
...
This is source plugin scaffolding. Rebuild your Unreal project after installing. It has not been compiled in this environment because Unreal Engine is not installed here.
